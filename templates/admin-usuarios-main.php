...
<div class="container mt-5">
    <div class="row mb-4">
        <div class="col-12">
            <h1 class="text-center display-4">Bienvenido, <?php echo htmlspecialchars($nombre_municipio); ?></h1>
        </div>
    </div>

    <div class="row justify-content-center">
        <div class="col-md-5 mb-4">
            <a href="arbolado.php?id_municipio=<?php echo $id_municipio; ?>" class="btn btn-primary btn-lg w-100 py-5 d-flex flex-column align-items-center justify-content-center">
